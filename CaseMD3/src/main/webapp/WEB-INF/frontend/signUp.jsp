...
<head>
    ...
    <link rel="stylesheet" href="/frontend/assets/style-lg.css">
...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    ...
    <div class="row border rounded-5 p-3 bg-white shadow box-area">
        ...
        <div class="col-md-6 rounded-4  d-flex justify-content-center align-items-center flex-column left-box"
            ...
            <div class="featured-image rounded-4 mb-3 mt-2">
                <img src="frontend\assets\image\trip.jpg" class="img-fluid" style="padding: 0 0; ">
            </div>
        ...
        <div class="col-md-6 right-box">
            <div class="row align-items-center">
                ...
                <div class="row">
                    <small>Bạn đã có tài khoản? <a href="signIn">Đăng nhập</a></small>
                </div>
            </div>
        </div>
        <!-- right Box End -->
